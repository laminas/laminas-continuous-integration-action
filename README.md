...
```json
{
  ...
  "command": "command to run to perform the check (empty in case you dont want to execute any command)",
  "debugCommand": "command to run to perform the check (null in case there is no specific debug command available)",
